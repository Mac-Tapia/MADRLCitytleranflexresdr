...
def verify_reward_profiles() -> None:
    ...
    require("bess_cycle_weight" in reward_text, "reward function must include unified_comparable_v4 BESS cycle penalty")
    ...
    for algorithm in ("HAPPO", "MASAC", "MATD3", "MAAC"):
        ...
        require(profile["profile_name"] == f"{algorithm.lower()}_unified_comparable_v4", f"{algorithm} reward profile is not unified comparable v4")
