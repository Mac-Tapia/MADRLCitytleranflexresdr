...
def synchronization_commands(args: argparse.Namespace) -> list[tuple[str, list[str]]]:
    ...
    ready_cmd = [
        py,
        "-B",
        "tools/dataset/check_training_dataset_ready.py",
        "--dataset-dir",
        dataset_dir,
        "--buildingcsv-dir",
    ...
    commands = [
        (
            ...
            [
                py,
                "-B",
                "tools/dataset/distill_building_loads.py",
                "--dataset-dir",
                dataset_dir,
                "--buildingcsv-dir",
                "CityLearn/data/buildingcsv",
                "--report-out",
                "tools/dataset/dataset_docs/distillation_report.csv",
            ],
        ),
        (
        ...
        (
            ...
            [
                py,
                "-B",
                "tools/dataset/fix_solar_pvlib.py",
                "--weather-source",
                "tmy",
                "--capacity-method",
                "power-density",
        ...
        (
            ...
            [
                py,
                "-B",
                "tools/dataset/audit_citylearn_csv_integrity.py",
                "--dataset-dir",
                dataset_dir,
                "--manifest-out",
        ...
        (
            ...
            [py, "-B", "tools/dataset/evaluate_dataset.py"],
        ),
        (
            "Analisis profundo de carga CityLearn v3 y normalizacion",
            [py, "-B", "tools/dataset/deep_dataset_analysis.py"],
        ),
        (
