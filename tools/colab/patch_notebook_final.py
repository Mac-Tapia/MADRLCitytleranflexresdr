...
NB_PATH = Path("d:/MADRLCitytleranflexresdr/examples_madrl_v3/madrl_citylearn_v3_tutorial.ipynb")
...
CELL_74B_SOURCE = (
    ...
    "            'seed': _seed,\n"
    "            'n_episodes': globals().get('N_EPISODES', 75),\n"
    ...
    "if _missing:\n"
    "    print()\n"
    "    print('  Artefactos pendientes (se generan tras entrenamiento 75 ep):')\n"
    "    for _m in _missing:\n"
    "        print(f'    - {_m}')\n"
    "print()\n"
...
RESUMEN_EXPORT_BLOCK = (
    ...
    "                ],\n"
    "                'n_episodios': globals().get('N_EPISODES', 75),\n"
