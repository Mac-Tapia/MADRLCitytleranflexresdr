...
- [x] **Sección 4.10.4 (nueva, 2026-06-13):** 4 aportes originales al motor de simulación — Battery degradación C-rate+Arrhenius (A1), PV corrección IEC 61215 temperatura tropical (A2), CostFunction.peak ventana facturación OSINERGMIN (A3), CarbonIntensityModel clase nueva (A4). Commit `54b1938e` submodulo CityLearn. Documentados en `docs/thesis/APORTES_SIMULACION_CITYLEARN_MADRL_TESIS.md`.
