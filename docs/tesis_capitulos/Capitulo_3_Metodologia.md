...
- **Pruebas estadísticas no paramétricas:** Shapiro-Wilk (normalidad), Kruskal-Wallis (diferencia global entre 4 algoritmos), Mann-Whitney U (pares, con tamaños de efecto Cliff's δ, Vargha-Delaney A12, Cohen d, Hedges g) y Wilcoxon signed-rank (pares pareados por KPI).
