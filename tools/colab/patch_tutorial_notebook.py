...
NOTEBOOK = Path(__file__).resolve().parents[2] / "examples_madrl_v3/madrl_citylearn_v3_tutorial.ipynb"
...
_REPO = globals().get('REPO', str(Path(__file__).resolve().parents[2] if '__file__' in dir() else Path.cwd()))
