# Module A: Bibliographic Search for Thesis Plan

## Objective

Search, verify, and systematize 50 relevant investigations from the last 10 years when possible to support the thesis plan.
...
Search around CityLearn v2, CityLearn Challenge, CityLearn Gymnasium, CityLearn datasets, carbon intensity, electricity pricing, demand response, flexibility, resilience, BESS, battery storage, EV charging, V2G, grid-interactive communities, wrappers, PettingZoo, Dec-POMDP, CTDE, MADRL, DRL, HAPPO, HATRPO, MASAC, MATD3, MAAC, MADDPG, MAPPO, COMA, QMIX, VDN, MARLlib, Optuna, energy flexibility, CO2 emissions, energy costs, virtual environments, digital twins, NREL datasets, OpenEI, Pecan Street, UK-DALE, REDD, REFIT, and Open Power System Data.
...
12. `("PhD thesis" OR "doctoral dissertation" OR "master thesis" OR "MSc thesis" OR "tesis doctoral" OR "tesis de maestría") AND ("multi-agent deep reinforcement learning" OR MADRL OR "deep reinforcement learning") AND ("demand response" OR "smart grid" OR "energy management" OR "CityLearn")`
...
Use at least: N.º; Año; Idioma; Tipo de documento; Título de la investigación; Autor(es); Universidad, revista o congreso; Indexación o fuente; País o contexto de estudio; Palabras clave asociadas; Relación con CityLearn v2; Relación con CityLearn v3 propuesto; Relación con MADRL; Relación con MARLlib; Problema de investigación; Objetivo de investigación; Variables de investigación; Nivel de investigación; Diseño de investigación; Metodología empleada; Algoritmo o modelo usado; Backend asociado; Tipo de cooperación; CTDE; Modelo formal; Observabilidad; Estado global usado; Observaciones locales usadas; Acciones de los agentes; Función de recompensa; Recompensa individual, compartida o híbrida; Enfoque multiobjetivo; Enfoque multicriterio; Uso de Optuna; Hiperparámetros ajustados; Métricas de entrenamiento MADRL; Entorno virtual o simulador usado; Dataset usado; Link del dataset; Variables del dataset; GitHub; PDF/artículo; DOI/enlace académico; KPIs de flexibilidad; KPIs de CO2; KPIs de costos; KPIs de respuesta de demanda; KPIs de resiliencia; Resultados principales; Resultados cuantitativos; Aporte a la ciencia; Conclusiones; Limitaciones; Aplicabilidad a CityLearn v3 propuesto; Aplicabilidad a sistemas eléctricos aislados; Aplicabilidad al SEAI Iquitos; Relación con PV/BESS/EV charging; Utilidad para la tesis; Prioridad de lectura; Cita APA en texto; Referencia APA completa; Observaciones de verificación.
