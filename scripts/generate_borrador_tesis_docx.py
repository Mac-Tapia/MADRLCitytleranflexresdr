...
Uso:
    .\.venv39-citylearn-v3\Scripts\python.exe -B scripts\generate_borrador_tesis_docx.py
"""
...
OUT_PATH = REPO / "docs" / "Borrador_Tesis_MADRL_CityLearn_Iquitos.docx"
...
def build(*, max_chapter: int | None = None):
    ...
    bullet(doc, "Metodologico: estudio cuantitativo, aplicado, comparativo, no experimental, basado en simulacion.")
    ...
    bullet(doc, "Enfoque: cuantitativo.")
    bullet(doc, "Tipo: aplicada.")
    bullet(doc, "Nivel: descriptivo, comparativo y propositivo.")
    bullet(doc, "Diseno: no experimental, transversal, basado en simulacion computacional y comparacion de algoritmos.")
    p(doc,
    ...
    p(doc,
      ...
      "orquestacion tools/orchestrate_citylearn_dataset.py (que invoca generate_iquitos_dataset.py "
    ...
    p(doc,
      ...
      "Oriente S.A. (tools/distill_building_loads.py); (c) senales regulatorias y de mercado "
    ...
    p(doc,
      ...
      "termino EV). El framework UC3M (capa 3, con 7 ejes de recompensa) es una "
      "infraestructura generica/auxiliar del proyecto y no es el canal de las corridas "
      "oficiales reportadas en el Capitulo 5.")
