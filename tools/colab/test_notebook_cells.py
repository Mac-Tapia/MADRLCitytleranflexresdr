...
# ────────────────────────────────────────────────────────────────────────────
NB = Path(f"{REPO}/examples_madrl_v3/madrl_citylearn_v3_tutorial.ipynb")
...
LAUNCHER_A100_CHECKS = {
    ...
    'parser.add_argument("--matd3-batch-size", default=256': "MATD3 batch_size=256 (v4 estable)",
    'parser.add_argument("--matd3-buffer-size", default=4096': "MATD3 buffer_size=4096 (v4 estable)",
