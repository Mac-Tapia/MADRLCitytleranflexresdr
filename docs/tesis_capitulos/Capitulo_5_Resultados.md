...
3. Interpretación honesta: distinguir resultados de la corrida completada v4 (5 episodios) de la configuración canónica objetivo (75 episodios), y señalar el carácter **preliminar** de las cifras.
...
## 5.3 Resultados obtenidos — Selección del mejor MADRL
...
### 5.3.1 Score por escenario (corrida v4)
...
### 5.3.2 KPIs físicos de la mejor corrida (MATD3 · E3, `training_summary.json`)
...
`[Pendiente: insertar en la versión final las figuras seleccionadas (p. ej. baseline_gain_by_kpi de MATD3-E2/E3) como evidencia visual.]`
...
4. **Carácter preliminar:** las cifras provienen de 5 episodios por job (presupuesto de 8 GB VRAM). La configuración canónica (75 episodios = 657 000 pasos) y múltiples semillas robustecerán las conclusiones.

---

### Estado del capítulo
**Con placeholders pendientes (datos por completar tras corrida canónica).** Pendientes: scores exactos por algoritmo/escenario de MASAC/MAAC/HAPPO; KPIs OE normalizados por algoritmo; porcentajes de mejora vs baseline; MWU/Wilcoxon de pares restantes; inserción de figuras.
