"""Create the thesis-plan workbook for Module A of the CityLearn v3 MADRL project."""
...
GENERIC_COLUMNS = ["Sección", "Contenido para plan", "Cita APA", "Fuente/Evidencia", "Observaciones"]
