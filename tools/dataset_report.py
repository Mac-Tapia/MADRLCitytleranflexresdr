...
print("=" * 100)
print("  Total filas por edificio: 26 304 (8760 + 8784 + 8760)")
print("  Columnas por edificio: 12")
print("  Total edificios: 17")
charger_count = len(list(BASE.glob("charger_*.csv")))
machine_count = len(list(BASE.glob("Washing_Machine_*.csv")))
print("  Total archivos: weather.csv + carbon_intensity.csv + pricing.csv +")
